...
const DoctorWardView = () => {
    ...
    const handleToggleCritical = async (bed_no, currentState) => {
        try {
            await api.put(`/staff/${hospital_id}/${ward_id}/patients/${bed_no}/critical`, { is_critical: !currentState });
            // Update local state
    ...
    const handleViewChart = (bed_no, patient) => {
        // Navigate relative to doctor layout
        navigate(`/doctor/ward/${hospital_id}/${ward_id}/patient/${bed_no}`, { state: { patient, wardName } });
    };
