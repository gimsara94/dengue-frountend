...
const CreateHospitalNurse = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await api.post('/hospital/nurses', formData);
            setStatus({ type: 'success', message: 'Nurse registered successfully for your hospital!' });
    ...
    return (
        <div className="admin-form-container" style={{ maxWidth: '800px', margin: '0 auto' }}>
            <div className="admin-form-header">
                ...
                <p className="admin-form-subtitle">Add a new nursing professional to your hospital staff.</p>
            </div>
...
export default CreateHospitalNurse;
